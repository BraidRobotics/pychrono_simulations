#!/usr/bin/env python3
"""Run all force_no_force experiment series with 90-second sleep between each."""
...
def main():
    ...
    # Get all force_no_force series, ordered by name
    ...
    print(f"Found {len(series_list)} force_no_force experiment series to run\n")
