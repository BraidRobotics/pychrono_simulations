...
initial_num_strands = 4
final_num_strands = 8

# Validate configuration before proceeding
errors = []
if initial_num_strands % 2 != 0:
    errors.append(f"Initial num_strands ({initial_num_strands}) must be divisible by 2 for symmetry.")
if final_num_strands % 2 != 0:
    errors.append(f"Final num_strands ({final_num_strands}) must be divisible by 2 for symmetry.")
if initial_num_strands < 2:
    errors.append(f"Initial num_strands ({initial_num_strands}) must be at least 2.")
if final_num_strands < 2:
    errors.append(f"Final num_strands ({final_num_strands}) must be at least 2.")
if initial_num_strands >= final_num_strands:
    errors.append(f"Initial num_strands ({initial_num_strands}) must be less than final num_strands ({final_num_strands}).")
...
initial_model = ExperimentSeries(
    ...
    num_strands=initial_num_strands,
