...
def upgrade() -> None:
    ...
    op.create_table('experiment_series',
        ...
        sa.Column('reset_force_after_seconds', sa.Integer(), nullable=True),
    ...
    op.create_table('experiments',
        ...
        sa.Column('torsional_force', sa.Float(), nullable=True),
        sa.Column('equilibrium_after_seconds', sa.Integer(), nullable=True),
        ...
        sa.Column('height_under_load', sa.Float(), nullable=True),
